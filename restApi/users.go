...
var errPasswordRequired = errors.New("password name is required")
...
func (s *UserService) handleUserRegister(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		fmt.Println(string(err.Error()))
		WriteJSON(w, http.StatusInternalServerError, ErrorResponse{Error: "Error creating sessions token"})
		return
	}
